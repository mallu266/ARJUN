...
namespace ARJUN\ADMIN\FUNCTIONS\ERRORLOGS;
...
class LOGVIEWER {
    ...
    public function __construct() {
        ...
        $this->storage_path = function_exists('config') ? config('errorlog.storage_path', storage_path('logs')) : storage_path('logs');
    }
    ...
    public function getFiles($basename = false, $folder = '') {
        $pattern = function_exists('config') ? config('errorlog.pattern', '*.log') : '*.log';

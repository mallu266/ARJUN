...
use ARJUN\ADMIN\FUNCTIONS\ERRORLOGS\LOGVIEWER;

/**
 * Class LogViewerController
 * @package ARJUN\LaravelLogViewer
 */
class QUEUELOGSCONTROLLER extends Controller {
...
//        echo "<pre>";print_r($data['logs'][0]['context']); exit;

        return view('admin::logs.queues')->with($data);
    }

                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" method="POST" action="{{ url('admin/users/action', @request()->segment(4)) }}">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="confpwd">ConfPassword:</label>
                                    <div class="col-sm-10"> 
                                        <input type="password" name="conf_password" class="form-control" id="confpwd" placeholder="Enter password">
                                    </div>
                                </div>
                                <div class="form-group"> 
